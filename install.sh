...
EOF
		...
		echo -e "${byellow}Golang will not be configured according to the user's preferences .${reset}\n"
	fi
...
function show_additional_help() {
	...
	echo ""
	echo "  ****             Without any arguments, the script will update Project Sleuth"
...
function handle_install_arguments() {
	echo -e "\n${bgreen}Project Sleuth installer/updater script${reset}\n"
